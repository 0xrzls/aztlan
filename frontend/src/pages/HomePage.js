...
const categories = ['All', 'Latest', 'Collections', 'Camp'];
...
function HomePage() {
      ...
      <div className="mx-4 pt-[64px] mb-24 space-y-6">
          ...
          <div className="h-full w-full rounded-[inherit] bg-black/40">
            ...
            <div className="flex flex-col px-6 pb-[4.5rem]">
              ...
              <div className="-mb-4 flex justify-between text-sm text-white/80">
                <span className="flex items-center gap-2"><FaUser size={16} />0</span>
            ...
            {categories.map((cat, i) => (
              <button
                ...
                className={`shrink-0 px-4 py-2 text-sm font-medium rounded-[10px] transition ${
                  i === 0 ? 'bg-white text-black' : 'text-white/70 hover:bg-white/10'
                }`}
              >
                {cat}
              </button>
          ...
          <div className="no-scrollbar overflow-x-auto">
            <div className="flex w-max gap-4">
              {sampleItems.map(title => (
                <div key={title} className="w-[170px] shrink-0 rounded-[10px] bg-[#1f1f1f]/80 ring-1 ring-black/30 backdrop-blur-md pb-4">
                  ...
                  <div className="px-3 pt-3">
                    ...
                    <div className="flex justify-between text-xs text-white/70">
                      <span className="flex items-center gap-1"><FaUser size={12} />0</span>
        ...
        <section className="space-y-4">
          ...
          <div className="no-scrollbar overflow-x-auto">
            <div className="flex w-max gap-4">
              {partners.map(name => (
                <div key={name} className="w-[96px] h-[96px] shrink-0 rounded-[10px] bg-[#1f1f1f]/80 ring-1 ring-black/30 backdrop-blur-md overflow-hidden flex items-center justify-center">
  ...
  <div className="relative w-full rounded-[10px] overflow-hidden ring-1 ring-black/30">
    ...
    <div className="grid grid-cols-2 grid-rows-2">
      <div className="p-6 space-y-3 text-white sprite-bg-1">
      ...
      <div className="p-6 space-y-3 text-white sprite-bg-2">
      ...
      <div className="p-6 space-y-3 text-white sprite-bg-3">
      ...
      <div className="p-6 flex items-center justify-center sprite-bg-4">
        <button className="text-white text-sm font-medium flex items-center gap-2">
          <PiBookOpenUserBold size={18} /> Learn
        </button>
      </div>
    </div>
  </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            {newAdded.map((item, idx) => (
              <div key={idx} className="flex bg-[#1f1f1f]/80 ring-1 ring-black/30 rounded-2xl overflow-hidden backdrop-blur-md">
